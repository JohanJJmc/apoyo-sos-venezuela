...
export function HomeActionPanel({ locationReady, address, isDetectingAddress, onClick }: HomeActionPanelProps) {
  return (
    <section className="absolute bottom-6 left-1/2 z-[900] w-[calc(100%-3.5rem)] max-w-sm -translate-x-1/2 rounded-card bg-white p-3 shadow-soft">
      <p className="mb-3 line-clamp-2 text-center text-[16px] font-extrabold text-[#00A651]">
        {isDetectingAddress
